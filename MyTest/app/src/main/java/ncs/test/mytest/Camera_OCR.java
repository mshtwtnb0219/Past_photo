...
public class Camera_OCR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            // 拒否していた場合
                ...
                ActivityCompat.requestPermissions(Camera_OCR.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            uploadImage(Uri.fromFile(cameraFile));
        }
    }
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        if (message.equals("2131558452")){
            message = "解析に失敗しました。カメラで撮り直してください。";
        }
    ...
    public  boolean onOptionsItemSelected(MenuItem item){
        ...
        if( item.getItemId() == R.id.edit){
            ...
            if(gettext.length() == 0){
                ...
                builder.setMessage("カメラで撮影してください！");
                builder.show();
                return true;
            }else if(gettext.equals("解析に失敗しました。カメラで撮り直してください。") ) {
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setMessage("カメラで撮り直してください。");
                builder.show();
                return true;
